...
export default function CampusRegisterForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Basic validation
        if (!campusName || !campusCode || !campusEmail || !password) return;

        setIsLoading(true);
        try {
            const response = await api.post('/Auth/campus_register', {
            ...
            <div className="w-full max-w-[400px] space-y-8">
                ...
                <div className="text-center space-y-2">
                    ...
                    <p className="text-zinc-500 text-sm">
                        Create your campus account to start trading sustainably.
                    </p>
                </div>
